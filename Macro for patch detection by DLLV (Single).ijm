...
lw2 = 25; //white lines; //full size = 50; half size = 25 
...
//Marker line thickness
yY = 5; //yellow outline line; //full size = 10; half size = 5
...
selectWindow("Log");
saveAs("Text", path+"_DLLV_variables.txt");
selectWindow("Log");
run("Close");